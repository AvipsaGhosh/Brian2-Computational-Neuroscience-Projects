...
Drift Diffusion Parameters (v, σ, a, T 
er
​
 )
...
Noise (σ): Internal stochastic variability is inversely related to attentional precision; greater Superior Colliculus precision produces lower internal noise.
...
er
​
 ): Represents processes occurring outside evidence accumulation, including sensory encoding and motor execution. Frontal Eye Field conflict contributes to increased delays.
...
Evidence increases according to the drift rate.

Random fluctuations are introduced through Gaussian noise.

Accumulation continues until the positive or negative decision boundary is reached.
